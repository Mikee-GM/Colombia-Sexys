...
export async function sembrar(qr: QueryRunner): Promise<void> {
  ...
  const usuarioBase = (
    ...
    telegram_verification_code: '482913',
  ...
  await insertarVarias(qr, 'extras_catalogo', [
    ...
    },
    {
      ...
      activo: true,
      es_generico: false,
      modelos_vinculadas_ids: [EMP.dos],
      speech_personalizado: null,
      created_at: dias(-90),
    },
    {
  ...
  await insertarVarias(qr, 'payment_receipt_validations', [
    {
      ...
      json_ia: { modelo: 'demo', campos_detectados: 12 },
      servicio_id: SRV.finalizado,
      jefe_id: U.jefe1,
    ...
    },
    {
      ...
      json_ia: { modelo: 'demo', campos_detectados: 0 },
      servicio_id: SRV.pendiente,
      jefe_id: U.jefe1,
      revisado_por_user_id: null,
      revisado_at: null,
      draft_payload: { duracion: 2, pago: 'transferencia' },
      created_at: horas(-1),
      updated_at: horas(-1),
    },
  ]);
  ...
  await insertarVarias(qr, 'viajes', [
    {
      ...
      choferes_notificados: [CHO.uno, CHO.dos],
  ...
  await insertarVarias(qr, 'liquidation_audit_log', [
    {
      ...
      before_value: { amount: 1800, status: 'pending' },
      after_value: { amount: 1800, status: 'pending', paid: 900 },
      created_at: dias(-7),
    },
  ]);
  ...
  await insertarVarias(
    ...
    guion.map((linea, i) => ({
      ...
      cliente_id: CLI.uno,
      servicio_id: SRV.finalizado,
      booking_session_id: 'demo-booking-0001',
  ...
  await insertarVarias(qr, 'group_service_requests', [
    {
      ...
      booking_session_id: 'demo-booking-0002',
      status: 'confirmada',
      duration_hours: 3,
      payment_method: 'efectivo',
