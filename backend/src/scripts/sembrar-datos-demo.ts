...
export async function sembrar(qr: QueryRunner): Promise<void> {
  ...
  await insertarVarias(qr, 'weekly_photo_submissions', [
    ...
    },
    {
      id: id(487),
      empleada_id: EMP.dos,
      url: 'https://ejemplo.local/demo/semanal-3.jpg',
      estado: 'aprobada_privada',
      semana_inicio: lunes,
      revisado_por_user_id: U.admin,
      motivo_rechazo: null,
      revisado_at: dias(-1),
    ...
    {
      // Sin esta, la cola de revision del panel sale siempre vacia.
      id: id(488),
      empleada_id: EMP.tres,
      url: 'https://ejemplo.local/demo/semanal-4.jpg',
      estado: 'pendiente',
      semana_inicio: lunes,
      revisado_por_user_id: null,
      motivo_rechazo: null,
