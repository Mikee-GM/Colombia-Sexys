  ...
  return <div className="space-y-8">
    ...
    <section className="rounded-2xl border border-[#C5A55A]/30 bg-[#0A0A0A] p-5 sm:p-6">
      ...
      <div className="mt-5 flex justify-end">
        <button type="button" disabled={pending} onClick={submitCoverage} className="rounded-xl border border-[#C5A55A] px-5 py-3 text-sm font-semibold text-[#C5A55A] hover:bg-[#C5A55A] hover:text-black disabled:opacity-50">Guardar cobertura</button>
      </div>
    </section>
